...
public class LottoSecondFragment_ViewBinding implements Unbinder {
  private LottoSecondFragment target;

  @UiThread
  public LottoSecondFragment_ViewBinding(LottoSecondFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LottoSecondFragment target = this.target;
